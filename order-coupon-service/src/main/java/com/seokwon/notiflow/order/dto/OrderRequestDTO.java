...
public class OrderRequestDTO {
    ...
    /**
     * Pessimistic Lock 적용 여부
     * @description true(기본값)면 기존과 동일하게 PESSIMISTIC_WRITE 락으로 순차 처리.
     * false면 락 없이 조회 후 차감 - 동시 요청 시 lost-update(오버셀)를 의도적으로 재현하기 위한
     * 데모/비교용 옵션. 값이 없으면(null) 락 적용(true)으로 간주.
     */
